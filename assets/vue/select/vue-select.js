        ...
        c = {
          ...
          methods: {
            maybeAdjustScroll: function () {
              var t,
                e = (
                  null === (t = this.$refs.dropdownMenu) || void 0 === t
                  ? void 0
                  : t.children[this.typeAheadPointer]) || !1;
              if (e) {
                ...
                if (s > n.bottom) 
                  return (this.$refs.dropdownMenu.scrollTop = e.offsetTop - (n.height - r));
                }
              },
      ...
      function h(t, e, n, o, i, s, r, a) {
        var l,
          c = "function" == typeof t
            ...
            : t;
        if ((
          e && ((c.render = e), (c.staticRenderFns = n), (c._compiled = !0)), o && (c.functional = !0), s && (c._scopeId = "data-v-" + s), r
          ? ((l = function (t) {
      ...
      var _ = {
          ...
          props: {
              ...
              default: function (t) {
                return "object" === r()(t)
                  ? t.hasOwnProperty(this.label)
                    ? t[this.label]
                    : console.warn('[vue-select warn]: Label key "option.'.concat(this.label, '" does not') + " exist in options object ".concat(JSON.stringify(t), ".\n") + "https://vue-select.org/api/props.html#getoptionlabel")
                  : t;
              }
            },
            getOptionKey: {
            ...
            createOption: {
              type: Function,
              default: function (t) {
                return "object" === r()(this.optionList[0])
                  ? l()({}, this.label, t)
                  : t;
              }
            },
          ...
          watch: {
            options: function (t, e) {
              ...
              !this.taggable && (
                ...
                ? n.resetOnOptionsChange(t, e, n.selectedValue)
                : n.resetOnOptionsChange) && this.clearSelection(),
          ...
          methods: {
            ...
            select: function (t) {
              ...
              this.isOptionSelected(t) || (this.taggable && !this.optionExists(t) && this.$emit("option:created", t), this.multiple && (t = this.selectedValue.concat(t)), this.updateValue(t), this.$emit("option:selected", t)),
            ...
            onSearchKeyDown: function (t) {
              ...
              if ("function" == typeof i[t.keyCode]) 
                return i[t.keyCode](t);
              }
            },
          computed: {
            ...
            selectedValue: function () {
              var t = this.value;
              return (
                this.isTrackingValues && (t = this.$data._value), t
                ? [].concat(t)
                : []);
            },
            optionList: function () {
          ...
          return n("div", {
            ...
            n("div", {
              ...
              n("div", {
                ...
                t._l(t.selectedValue, function (e) {
                  return t._t("selected-option-container", [n("span", {
                      ...
                      t.multiple
                        ...
                        }, [n(t.childComponents.Deselect, {tag: "component"})], 1)
                        : t._e()
                    ], 2)], {
                ...
                t._v(" "),
                t._t("search", [n("input", t._g(t._b({
                    staticClass: "vs__search"
                  }, "input", t.scope.search.attributes, !1), t.scope.search.events))], null, t.scope.search)
              ], 2),
              t._v(" "),
              n("div", {
                ref: "actions",
                ...
                t._t("open-indicator", [
                  t.noDrop
                    ? t._e()
                    : n(t.childComponents.OpenIndicator, t._b({
                      tag: "component"
                    }, "component", t.scope.openIndicator.attributes, !1))
                ], null, t.scope.openIndicator),
                t._v(" "),
                t._t("spinner", [n("div", {
                    directives: [
                      {
                  ...
                  }, [t._v("Loading...")])], null, t.scope.spinner)
              ], 2)
            ]),
            t._v(" "),
            n("transition", {
              ...
              t.dropdownOpen
                ? n("ul", {
                  ...
                  0 === t.filteredOptions.length
                    ...
                    }, [t._t("no-options", [t._v("Sorry, no matching options.")], null, t.scope.noOptions)], 2)
                    : t._e(),
                  t._v(" "),
