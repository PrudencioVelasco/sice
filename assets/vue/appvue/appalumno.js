...
var v = new Vue({
    ...
    methods: {
        ...
        updateAlumno() {
            ...
            axios.post(this.url + "Alumno/updateAlumno", formData).then(function (response) {
                if (response.data.error) {
                    v.formValidate = response.data.msg;
                    v.cargando = false;
                    v.error = true;
        ...
        updatePasswordAlumno() {
            ...
            v.cargando = true;
            var formData = v.formData(v.chooseAlumno);
            axios.post(this.url + "Alumno/updatePasswordAlumno", formData).then(function (response) {
                if (response.data.error) {
                    v.formValidate = response.data.msg;
                    v.error = true;
                    v.cargando = false;
