...
var v = new Vue({
  ...
  methods: {
    ...
    showAllEspecialidades() {
      axios.get(this.url + "Materia/showAllEspecialidades/").then(response => (this.especialidades = response.data.especialidades));
    },
    showAllClasificaciones() {
      axios.get(this.url + "Materia/showAllClasificaciones/").then(response => (this.clasificacion_materia = response.data.clasificaciones));
    },
    showAllNiveles() {
      axios.get(this.url + "Materia/showAllNiveles/").then(response => (this.niveles = response.data.niveles));
    },
    searchMateria() {
