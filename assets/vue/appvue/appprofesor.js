...
var v = new Vue({
    ...
    methods: {
        ...
        showAll() {
            axios.get(this.url + "Profesor/showAll").then(function (response) {
        ...
        updateProfesor() {
            v.cargando = true;
            v.error = false;
            var formData = v.formData(v.chooseProfesor);
            axios.post(this.url + "Profesor/updateProfesor", formData).then(function (response) {
                if (response.data.error) {
                    v.formValidate = response.data.msg;
                    v.error = true;
                    v.cargando = false;
        ...
        updatePasswordProfesor() {
            ...
            v.error = false;
            var formData = v.formData(v.chooseProfesor);
            axios.post(this.url + "Profesor/updatePasswordProfesor", formData).then(function (response) {
                if (response.data.error) {
                    v.formValidate = response.data.msg;
                    v.error = true;
                    v.cargando = false;
