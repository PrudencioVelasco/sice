...
var v = new Vue({
    ...
    methods: {
        ...
        showAll() {
            axios.get(this.url + "CicloEscolar/showAll").then(function (response) {
        ...
        updateCiclo() {
            v.cargando = true;
            v.error = false;
            var formData = v.formData(v.chooseCiclo);
            axios.post(this.url + "CicloEscolar/updateCiclo", formData).then(function (response) {
                if (response.data.error) {
                    v.formValidate = response.data.msg;
                    v.error = true;
                    v.cargando = false
