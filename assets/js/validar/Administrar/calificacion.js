$(document).ready(function () {
    ...
    $(document).on("click", '.add_button_calificacion_prepa', function (e) {
        var nombre = $(this).data('alumno');
        var idhorario = $(this).data('idhorario');
        var idalumno = $(this).data('idalumno');
        var idhorariodetalle = $(this).data('idhorariodetalle');
        var idunidad = $(this).data('idunidad');
        var idoportunidadexamen = $(this).data('idoportunidadexamen');
        $(".idhorariodetalle").val(idhorariodetalle);
        $(".idalumno").val(idalumno);
        $(".idhorario").val(idhorario);
        $(".idunidad").val(idunidad);
        $(".idoportunidadexamen").val(idoportunidadexamen);
        $("#alumno_calificacion_add_prepa").text(nombre);
    });
    $(document).on("click", '.edit_button_calificacion_prepa', function (e) {
        var nombre = $(this).data('alumno');
        var idcalificacion = $(this).data('idcalificacion');
        var calificacion = $(this).data('calificacion');
        $(".calificacion").val(calificacion);
        $(".idcalificacion").val(idcalificacion);
        $("#alumno_calificacion_edit_prepa").text(nombre);
    });
    $(document).on("click", '.delete_button_calificacion_prepa', function (e) {
        var nombre = $(this).data('alumno');
        var idcalificacion = $(this).data('idcalificacion');  
        $(".idcalificacion").val(idcalificacion);
        $("#alumno_calificacion_delete_prepa").text(nombre);
    });
    ...
    $("#btndeletecalificacionprepa").click(function () {
        $('#btndeletecalificacionprepa').prop("disabled", true);
        $('#btndeletecalificacionprepa').html(
            `<span class="fa fa-spinner spinner-border-sm" role="status" aria-hidden="true"></span> PROCESANDO...`
        );
        $.ajax({
            type: "POST",
            url: my_var_1 + "Calificacion/deleteCalificacionAdminPrepa",
            data: $('#frmdeletecalificacionprepa').serialize(),
            success: function (data) {
                $('#btndeletecalificacionprepa').prop("disabled", false);
                $('#btndeletecalificacionprepa').html(
                    `<i class='fa fa-trash'></i> ELIMINAR`
                );
                var val = $.parseJSON(data);
    ...
    $("#btnaddcalificacionprepa").click(function () {
        $('#btnaddcalificacionprepa').prop("disabled", true);
        $('#btnaddcalificacionprepa').html(
            `<span class="fa fa-spinner spinner-border-sm" role="status" aria-hidden="true"></span> PROCESANDO...`
        );
        $.ajax({
            type: "POST",
            url: my_var_1 + "Calificacion/addCalificacionAdminPrepa",
            data: $('#frmaddcalificacionprepa').serialize(),
            success: function (data) {
                $('#btnaddcalificacionprepa').prop("disabled", false);
                $('#btnaddcalificacionprepa').html(
    ...
    $("#btneditcalificacionprepa").click(function () {
        $('#btneditcalificacionprepa').prop("disabled", true);
        $('#btneditcalificacionprepa').html(
            `<span class="fa fa-spinner spinner-border-sm" role="status" aria-hidden="true"></span> PROCESANDO...`
        );
        $.ajax({
            type: "POST",
            url: my_var_1 + "Calificacion/updateCalificacionAdminPrepa",
            data: $('#frmeditcalificacionprepa').serialize(),
            success: function (data) {
                $('#btneditcalificacionprepa').prop("disabled", false);
                $('#btneditcalificacionprepa').html(
                    `<i class='fa fa fa-pencil'></i> MODIFICAR`
                );
                var val = $.parseJSON(data);
