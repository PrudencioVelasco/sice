             ...
             <div class="modal-body">
                     ...
                     <div class="col-md-6 col-sm-12 col-xs-12 ">
                         <div class="form-group">
                             <select style="border-bottom: solid #ebebeb 2px; margin-top:15px;" @change="onChange($event)" v-model="newCobroInicio.idtipopagocol" :class="{'is-invalid': formValidate.idtipopagocol}" class="form-control">
                                 ...
                                 <option v-for="option in tipospago" v-bind:value="{id:option.idtipopagocol,text:option.concepto}">
                                     {{ option.concepto }}
                                 </option>
                             </select>
                 ...
                 <div class="row clearfix ">
                         ...
                         <div class="form-group form-float">
                             <div class="form-line">
                                 <label class="form-label">
                                     <font color="red">*</font> TOTAL A PAGAR
                                 </label>
                     ...
                     <div class="col-md-2 col-sm-2 col-xs-12 ">
                         <div class="form-group">
                             <button @click="agregar_forma_pago_otros()" class="btn btn-info"> <i class="fa fa-plus" aria-hidden="true"></i> Agregar</button>
                         </div>
                     </div>
                 </div>
                 <div class="row">
                         ...
                         <table class=" table table-striped dt-responsive nowrap" cellspacing="0">
                             ...
                             <tbody>
                                 <tr v-for="(row, index) in array_pago_colegiatura">
                                     ...
                                     <td align="right"><button @click="deleteItem(index)" class="btn btn-warning">Quitar</button></td>
                                 </tr>
                             </tbody>
                         </table>
                     </div>
             ...
             <div class="modal-body">
                 ...
                 <div class="row">
                     <div class="col-md-8 col-sm-6 col-xs-12 ">
                         <div class="form-group">
                             <label>
                                 <font color="red">*</font> MES A PAGAR
                             </label>
                             <p>
