                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12 ">
                            <div class="form-group form-float ">
                                <div class="form-line">
                                    ...
                                    <input type="text" v-model="newAlumno.matricula" class="form-control"
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12 ">
                            <div class="form-group form-float">
                                <div class="form-line">
                                    ...
                                    <input type="text" v-model="newAlumno.nombre" class="form-control"
                                        :class="{'is-invalid': formValidate.nombre}" name="po">
                                </div>
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12 ">
                            <div class="form-group form-float">
                                <div class="form-line">
                                    ...
                                    <input type="text" v-model="newAlumno.apellidop" class="form-control"
                                        :class="{'is-invalid': formValidate.apellidop}" name="po">
                                </div>
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12 ">
                            <div class="form-group  form-float">
                                <div class="form-line">
                                    ...
                                    <input type="text" v-model="newAlumno.apellidom" class="form-control"
                                        :class="{'is-invalid': formValidate.apellidom}" name="po">
                                </div>
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12 ">
                            <div class="form-group form-float">
                                <div class="form-line">
                                    ...
                                    <input type="text" v-model="newAlumno.nacionalidad" class="form-control"
                                        :class="{'is-invalid': formValidate.nacionalidad}" name="po">
                                </div>
                    ...
                    <div class="row  clearfix">
                        <div class="col-md-6 col-sm-12 col-xs-12 ">
                            <div class="form-group">
                                ...
                                <select style="border-bottom: solid #ebebeb 2px;" v-model="newAlumno.idtiposanguineo"
                            ...
                            <div class="form-group " style="display: block;">
                                ...
                                <div class="demo-radio-button" style="display: block;">
                                    <input name="group5" type="radio" id="radio_31" class="with-gap radio-col-blue"
                                        v-model="newAlumno.sexo" value="1" />
                                    <label for="radio_31">HOMBRE</label>
                                    <input name="group5" type="radio" id="radio_32" class="with-gap radio-col-pink"
                                        v-model="newAlumno.sexo" value="0" />
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12 ">
                            <div class="form-group form-float">
                                <div class="form-line">
                                    ...
                                    <input type="text" v-model="newAlumno.fechanacimiento" id="date"
                                        class="form-control" :class="{'is-invalid': formValidate.fechanacimiento}"
                                        name="po">
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12 ">
                            <div class="form-group form-float">
                                <div class="form-line">
                                    ...
                                    <input type="text" v-model="newAlumno.numfolio" class="form-control"
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12 ">
                            <div class="form-group form-float">
                                <div class="form-line">
                                    ...
                                    <input type="text" v-model="newAlumno.numacta" class="form-control"
                    ...
                    <div class="row clearfix">
                        <div class="col-md-6 col-sm-12 col-xs-12 ">
                            <div class="form-group form-float">
                                <div class="form-line">
                                    ...
                                    <input type="text" v-model="newAlumno.numlibro" class="form-control"
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12 ">
                            <div class="form-group">
                                ...
                                <select style="border-bottom: solid #ebebeb 2px;" v-model="newAlumno.idespecialidad"
                                    :class="{'is-invalid': formValidate.idespecialidad}" class="form-control">
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12 ">
                            <div class="form-group form-float">
                                <div class="form-line">
                                    ...
                                    <input type="text" v-model="newAlumno.correo" class="form-control"
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12 ">
                            <div class="form-group form-float">
                                <div class="form-line">
                                    ...
                                    <input type="test" v-model="newAlumno.domicilio" class="form-control"
            ...
            <div class="modal-footer">
                <div class="row">
                    <div class="col-md-6 col-sm-12 col-xs-12 " align="center">
                        <div v-if="cargando">
                            <img style="width: 50px;" src="<?php echo base_url() . '/assets/loader/pagos.gif' ?>"
                    ...
                    <div class="col-md-6 col-sm-12 col-xs-12 " align="right">
                        ...
                        <button class="btn btn-primary waves-effect waves-black" @click="addAlumno"><i
                                class='fa fa-floppy-o'></i> Agregar</button>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="modal-body">
                <div
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12 ">
                            <div class="form-group form-float">
                                <div class="form-line focused">
                                    ...
                                    <input type="text" v-model="chooseAlumno.matricula" class="form-control"
                                        :value="chooseAlumno.matricula" :class="{'is-invalid': formValidate.matricula}"
                                        name="po">
                                </div>
                                <div class="col-red" v-html="formValidate.matricula"></div>
                            </div>
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12 ">
                            <div class="form-group form-float">
                                <div class="form-line focused">
                                    ...
                                    <input type="text" v-model="chooseAlumno.nombre" class="form-control"
                                        :class="{'is-invalid': formValidate.nombre}" name="po">
                                </div>
                                <div class="col-red" v-html="formValidate.nombre"></div>
                            </div>
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12 ">
                            <div class="form-group form-float">
                                <div class="form-line focused">
                                    ...
                                    <input type="text" v-model="chooseAlumno.apellidop" class="form-control"
                                        :class="{'is-invalid': formValidate.apellidop}" name="po">
                                </div>
                                <div class="col-red" v-html="formValidate.apellidop"></div>
                            </div>
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12 ">
                            <div class="form-group form-float">
                                <div class="form-line focused">
                                    <label class="form-label">A. MATERNO</label>
                                    <input type="text" v-model="chooseAlumno.apellidom" class="form-control"
                                        :class="{'is-invalid': formValidate.apellidom}" name="po">
                                </div>
                                <div class="col-red" v-html="formValidate.apellidom"></div>
                            </div>
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12 ">
                            <div class="form-group form-float">
                                <div class="form-line focused">
                                    ...
                                    <input type="text" v-model="chooseAlumno.nacionalidad" class="form-control"
                                        :class="{'is-invalid': formValidate.nacionalidad}" name="po">
                                </div>
                                <div class="col-red" v-html="formValidate.nacionalidad"></div>
                            </div>
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12 ">
                            <div class="form-group">
                                <select style="border-bottom: solid #ebebeb 2px;" v-model="chooseAlumno.idtiposanguineo"
                                    :class="{'is-invalid': formValidate.idtiposanguineo}" class="form-control">
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12 ">
                            <div class="form-group">
                                <select style="border-bottom: solid #ebebeb 2px;" v-model="chooseAlumno.idestatusalumno"
                                    :class="{'is-invalid': formValidate.idestatusalumno}" class="form-control">
                                    <option value="">-- ESTATUS ALUMNO --</option>
                                    <option v-for="option in estatusalumno"
                                        selected="option.idestatusalumno == chooseAlumno.idestatusalumno ? 'selected' : ''"
                                        v-bind:value="option.idestatusalumno">
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12 ">
                            <div class="form-group">
                                ...
                                <div class="demo-radio-button">
                                    <input name="group5" type="radio" id="radio_31" class="with-gap radio-col-blue"
                                        v-model="chooseAlumno.sexo" value="1" :checked="chooseAlumno.sexo==1" />
                                    <label for="radio_31">HOMBRE</label>
                                    <input name="group5" type="radio" id="radio_32" class="with-gap radio-col-pink"
                                        v-model="chooseAlumno.sexo" value="0" :checked="chooseAlumno.sexo==0" />
                                    <label for="radio_32">MUJER</label>
                                </div>
                                <div class="col-red" v-html="formValidate.sexo"></div>
                            </div>
                    ...
                    <div class="row clearfix">
                        <div class="col-md-6 col-sm-12 col-xs-12 ">
                            <div class="form-group form-float">
                                <div class="form-line focused">
                                    ...
                                    <input type="text" v-model="chooseAlumno.fechanacimiento" class="form-control"
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12 ">
                            <div class="form-group">
                                ...
                                <select style="border-bottom: solid #ebebeb 2px;" v-model="chooseAlumno.idespecialidad"
                                    :class="{'is-invalid': formValidate.idespecialidad}" class="form-control">
...
<div class="modal fade" id="changePassword" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div
                    style=" height: 100px; padding-top:13px; padding-right:15px; overflow-x: hidden; overflow-y: scroll;">
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12 ">
                            <div class="col-red" v-html="formValidate.msgerror"></div>
                        </div>
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12 ">
                            <div class="form-group form-float">
                                <div class="form-line  ">
                                    ...
                                    <input type="password" v-model="chooseAlumno.password1" class="form-control"
                                        :class="{'is-invalid': formValidate.password1}" name="po">
                                </div>
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12 ">
                            <div class="form-group form-float">
                                <div class="form-line  ">
                                    ...
                                    <input type="password" v-model="chooseAlumno.password2" class="form-control"
                                        :class="{'is-invalid': formValidate.password2}" name="po">
                                </div>
            ...
            <div class="modal-footer">
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12 col-xs-12 ">
                        <button class="btn btn-danger waves-effect waves-black" @click="clearAll"><i
                                class='fa fa-ban'></i> Cancelar</button>
                        <button class="btn btn-primary waves-effect waves-black" @click="updatePasswordAlumno"><i
                                class='fa fa-edit'></i> Modificar</button>
                    </div>
                </div>
            </div>
