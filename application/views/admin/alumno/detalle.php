                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                <?php }
                                                    ...
                                                    echo "<tr><td colspan='4'>No existe Kardex del alumno.</td></tr>";
                                                } ?>
                                            </tbody>
                                        </table>
                                                            ...
                                                            <tfoot>
                                                                <tr>
                                                                    <td colspan="4" align="right">
                                                                        <pagination :current_page="currentPage" :row_count_page="rowCountPage" @page-update="pageUpdate" :total_users="totalTutores" :page_range="pageRange">
                                                                        </pagination>
                                                                    </td>
                                                                </tr>
                                                            </tfoot>
