            ...
            <div class="modal-body">
                        ...
                        <div class="form-group form-float">
                            <div class="form-line">
                                <label class="form-label">
                                    <font color="red">*</font> NOMBRE DE LA ASIGNATURA/CURSO
                                </label>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12 col-xs-12 ">
                        <div class="form-group">
                            <label>
                                <font color="red">*</font> SE CALIFICA?
                            </label>
                    ...
                    <div class="col-md-6 col-sm-12 col-xs-12 ">
                        <div class="form-group">
                            <select style="border-bottom: solid #ebebeb 2px;" class="form-control" v-model="chooseMateria.idnivelestudio">
                                ...
                                <option v-if="idniveleducativo == 1 || idniveleducativo == 2 || idniveleducativo == 4" v-for="option in niveles" :selected="option.idnivelestudio == chooseMateria.idnivelestudio ? 'selected' : ''" :value="option.idnivelestudio">
                                    {{ option.numeroordinaria }}</small>
                                </option>
                                <option v-if="idniveleducativo == 3 || idniveleducativo == 5" v-for="option in niveles" :selected="option.idnivelestudio == chooseMateria.idnivelestudio ? 'selected' : ''" :value="option.idnivelestudio">
                                    {{ option.numeroromano }}</small>
                                </option>
