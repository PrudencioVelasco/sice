                ...
                <div style="padding-top:13px;">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-12 col-xs-12 ">
                            <div class="form-group">
                                <label>
                                    <font color="red">*</font> MES INICIO
                                </label>
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12 ">
                            <div class="form-group">
                                <label>
                                    <font color="red">*</font> AÑO INICIO
                                </label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12 ">
                            <div class="form-group">
                                <label>
                                    <font color="red">*</font> MES TERMINO
                                </label>
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12 ">
                            <div class="form-group">
                                <label>
                                    <font color="red">*</font> AÑO TERMINO
                                </label>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12 ">
                            <div class="form-group">
                                ...
                                <input type="text" v-model="newCiclo.descripcion" class="form-control" style="border:solid #ccc 1px; padding-left:10px;" :class="{'is-invalid': formValidate.descripcion}" name="po">
                ...
                <div style="padding-top:13px; padding-right:15px;">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12 ">
                            <div class="form-group">
                                <label> DESCRIPCIÓN</label>
                                <input type="text" v-model="chooseCiclo.descripcion" class="form-control" style="border:solid #ccc 1px; padding-left:10px;" :class="{'is-invalid': formValidate.descripcion}" name="po">
                                <div class="col-red" v-html="formValidate.descripcion"></div>
