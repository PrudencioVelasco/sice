                                                                            ...
                                                                            <div class="btn-group" role="group">
                                                                                ...
                                                                                <ul class="dropdown-menu">
                                                                                    ...
                                                                                    if ($this->session->idniveleducativo ==  1  || $this->session->idniveleducativo ==  2) { ?>
                                                                                        <li><a href="#" v-bind:href="'detalle/'+ row.idunidad"><i style="color:#000000;" class="fa fa-list-alt" aria-hidden="true"></i> Detalles</a></li>
                                                                                    <?php }
                                                                                    ?>
                                                            ...
                                                            <tfoot>
                                                                <tr>
                                                                    <td colspan="4" align="right">
                                                                        <pagination :current_page="currentPage" :row_count_page="rowCountPage" @page-update="pageUpdate" :total_users="totalUnidades" :page_range="pageRange">
                                                                        </pagination>
                                                                    </td>
                                                                </tr>
                                                            </tfoot>
                                                            ...
                                                            <tfoot>
                                                                <tr>
                                                                    <td colspan="3" align="right">
                                                                        <pagination :current_page="currentPage" :row_count_page="rowCountPage" @page-update="pageUpdate" :total_users="totalOportunidades" :page_range="pageRange">
                                                                        </pagination>
                                                                    </td>
                                                                </tr>
                                                            </tfoot>
