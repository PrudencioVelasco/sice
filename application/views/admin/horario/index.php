                                    ...
                                    <div class="col-md-12  col-sm-12 col-xs-12">
                                        ...
                                        <table class="table table-hover table-striped">
                                            <thead class="bg-teal">
                                                ...
                                                <th class="text-white" v-column-sortable:descripcionhorario>Clave </th>
                                            ...
                                            <tbody class="table-light">
                                                <tr v-for="horario in horarios" class="table-default">
                                                    ...
                                                    <td v-if="horario.descripcion != ''">{{horario.mesinicio}} - {{horario.mesfin}} {{horario.yearfin}} / {{horario.descripcion}}</td>
                                                    <td v-else>{{horario.mesinicio}} - {{horario.mesfin}} {{horario.yearfin}}</td>
                                                    <td>
                                                    ...
                                                    <td>{{horario.descripcionhorario}}</td>
                                            ...
                                            <tfoot>
                                                <tr>
                                                    <td colspan="6" align="right">
                                                        <pagination :current_page="currentPage" :row_count_page="rowCountPage" @page-update="pageUpdate" :total_users="totalHorarios" :page_range="pageRange">
                                                        </pagination>
                                                    </td>
                                                </tr>
                                            </tfoot>
