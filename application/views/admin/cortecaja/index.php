                                ...
                                <div class="row"> 
                                    <div class="col-md-2 col-sm-12 col-xs-12 ">
                                        <div class="form-group">
                                            ...
                                            <input type="date"  style="border:solid 1px #ccc;" class="form-control" id="fechainicio" name="fechainicio"> 
                                        </div>
                                    </div> 
                                    <div class="col-md-2 col-sm-12 col-xs-12 ">
                                        <div class="form-group">
                                            <label><font color="red">*</font> a</label>
                                            <input type="date" style="border:solid 1px #ccc;" class="form-control" id="fechafin"  name="fechafin"> 
                                        </div>
                                    </div> 
                                    <div class="col-md-2 col-sm-12 col-xs-12 ">
                                        <div class="form-group">
                                            <label><font color="red">*</font> Pagó en</label>
                                            <select class="form-control" name="pagoen" id="pagoen" style=" border-bottom: solid 1px #ccc;" >
                                    ...
                                    <div class="col-md-2 col-sm-12 col-xs-12 ">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="estatus" id="estatus"  style=" border-bottom: solid 1px #ccc;">
                                                <option value="">TODOS</option> 
                                            ...
                                            if (isset($pago_inicio) && !empty($pago_inicio)) {
                                                foreach ($pago_inicio as $value) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo $value->detallepago; ?></td>
                                            ...
                                            if (isset($pago_mensualidad) && !empty($pago_mensualidad)) {
                                                foreach ($pago_mensualidad as $value) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo $value->concepto . ' DE ' . $value->mes; ?></td>
                                                        <td><strong><?php echo number_format($value->descuento, 2); ?></strong></td>
                                                        <td><?php echo $value->detallepago; ?></td>
                                                        <td><?php echo $value->fechapago; ?></td>
                                                        <td><?php echo $value->usuario; ?></td>
