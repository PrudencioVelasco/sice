        ...
        <div class="x_title">
           <div class="col-md-6 col-sm-12 col-xs-12 ">
            ...
            <div class="col-md-6 col-sm-12 col-xs-12 " align="right">
              ...
              <a target="_blank" href="<?php echo site_url('Tutores/descargar/'.$controller->encode($idhorario).'/'.$controller->encode($idalumno)) ?>" class="btn btn-primary">IMPRIMIR HORARIO</a>
            <?php } ?>
            </div>
