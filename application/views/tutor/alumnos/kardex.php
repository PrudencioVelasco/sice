                                ...
                                <td align="right">
                                    ...
                                    <div class="btn-group" role="group">
                                        ...
                                        <ul class="dropdown-menu"> 
                                            <li><a href="<?php echo site_url('alumno/historial/'.$row->idhorario.'/'.$idalumno) ?>"><i class="fa fa-list-alt" aria-hidden="true"></i> Boleta</a></li> 
                                            <li><a href="<?php echo site_url('alumno/horario/'.$row->idhorario.'/'.$idalumno) ?>"><i class="fa fa-clock-o"></i> Horario</a></li> 
