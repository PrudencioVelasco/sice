             ...
             <div id="appd">
                  <div class="row">
                           <div class="col-md-12" align="right"> 
                              <a  class="btn btn-round btn-primary" href="<?php echo base_url(); ?>/Alumno/generarHorarioPDF/<?php echo $idhorario."/".$idalumno ?>"> <i class="fa fa-file-pdf-o"></i> Generar PDF</a>
                            </div> 
                  </div> 
                   <table class="table">
                    <thead>
