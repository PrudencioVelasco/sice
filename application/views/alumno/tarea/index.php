    ...
    <div class="">
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2><strong><i class="fa fa-book"></i> BIENVENIDO A SICE</strong></h2>
                            ...
                            <div id="apptarea">
                                <div class="container">
                                    ...
                                    <div class="alert alert-info">
                                        <strong>Info!</strong> Los mensajes los podras encontrar entrando en la opción de: Clases
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12  col-sm-12 col-xs-12">
                                            <div class="row">
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        ?>
                                                        <strong><?php //echo $value->nombreclase; 
                                                                ?></strong></td>
                                                        <td><?php
                                                            ...
                                                            */
                                                            ?>
                                                            <a href=""></a>
                                                            <a href="<?php //echo site_url('Aalumno/detallemensaje/' . $controller->encode($value->idmensaje)); 
                                                                        ?>"> LEER MAS... </a>
                                                            <?php
                                                            /*} else {
                                                            echo $value->mensaje;
...
<script data-my_var_1="<?php echo base_url()
                        ?>" data-my_var_2="<?php echo $controller->encode($idhorario);
                                            ?>" data-my_var_3="<?php echo $controller->encode($idalumno);
                                                                    ?>" src="<?php echo base_url();
                                                                                ?>/assets/vue/appvue/alumno/tarea/apptarea.js"></script>
