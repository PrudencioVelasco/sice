...
<head>
    ...
    <link href="<?php echo base_url(); ?>/assets/js/lightbox/ekko-lightbox.css" rel="stylesheet">
                    ...
                    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                        ...
                        <div class="menu_section">
                            ...
                            <ul class="nav side-menu">
                                ...
                                <li><a href="<?= base_url('/Aalumno/horariov2') ?>"><i class="fa fa-calendar"></i> Horario</a></li>
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            <li class="">
                                ...
                                <ul class="dropdown-menu dropdown-usermenu animated fadeInDown pull-right">
                                    <li><a href="<?= base_url('/perfil/alumno') ?>"><i class="fa fa-cog pull-right"></i> PERFIL</a>
                                    </li>
