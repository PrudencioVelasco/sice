    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2><strong>CALIFICACIONES DE FORMACIÓN INTERNA - <?php
                                                    ...
                                                    <table class="table table-striped  ">
                                                        <thead class="bg-teal">
                                                            <tr>
                                                                ...
                                                                <th></th>
                                                                <?php
                                                                if (isset($idmateria) && !empty($idmateria) && $idmateria == 186) {
                                                                    echo '<th></th>';
                                                                }
                                                                ?>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            ?>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <input type="text" name="conducta[]" class="form-control" placeholder="Conducta">
                                                                        </td>
                                                                        <td>
                                                                            <input type="text" name="limpieza[]" class="form-control" placeholder="Limpeza">
                                                                        </td>
                                                                        <td>
                                                                        ...
                                                                        <td>
                                                                            <input type="text" name="uniforme[]" class="form-control" placeholder="Uniforme">
                                                                        </td>
                                                                        <?php
                                                                        if (isset($idmateria) && !empty($idmateria) && $idmateria == 186) {
                                                                            echo '<td>
                                                                                    <input type="text" name="robotica[]" class="form-control" placeholder="Robotica">
                                                                                </td>';
                                                                        }
                                                                        ?>
...
<script data-my_var_1="<?php echo base_url() ?>" src="<?php echo base_url(); ?>/assets/js/validar/examen_interno.js"></script>
