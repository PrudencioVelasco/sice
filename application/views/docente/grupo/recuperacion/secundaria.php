                                                        ...
                                                        <tbody>
                                                            ...
                                                            if (isset($alumnos) && !empty($alumnos)) {
                                                                ...
                                                                foreach ($alumnos as $value) {
                                                                    if ($value->calificacion < $calificacion_minima) {
                                                                        ?>
...
src="<?php echo base_url(); ?>/assets/js/validar/recuperacion_secundaria.js"></script>
