                                ...
                                <div class="row" aling="right">
                                    <div class="col-md-2 col-sm-12 col-xs-12 " align="right">
                                        <div class="form-group">
                                            <label class="form-label">
                                                <font color="red">*</font> De:
                                            </label>
                                            <input type="date" style="border: solid 1px #ccc" v-model="buscarRegistros.fechainicio" class="form-control" :class="{'is-invalid': formValidate.fechainicio}" name="po">
                                    ...
                                    <div class="col-md-2 col-sm-12 col-xs-12 " align="right">
                                        <div class="form-group">
                                            ...
                                            <input type="date" style="border: solid 1px #ccc" v-model="buscarRegistros.fechafin" class="form-control" :class="{'is-invalid': formValidate.fechafin}" name="po">
                                    ...
                                    <div class="col-md-4 col-sm-12 col-xs-12 ">
                                        <div class="form-group" align="right">
                                            ...
                                            <input type="text" style="border: solid 1px #ccc; margin-top: 5px;padding-left:10px;" v-model="buscarRegistros.texto" class="form-control" :class="{'is-invalid': formValidate.texto}" name="po" placeholder="Buscar">
...
<script data-my_var_1="<?php echo base_url() ?>" data-my_var_2="<?php echo $idhorario; ?>" data-my_var_3="<?php echo $idhorariodetalle ?>" src="<?php echo base_url(); ?>/assets/vue/appvue/docente/tarea/apptarea_principal.js?1.0"></script>