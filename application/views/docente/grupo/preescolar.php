		...
		<div class="row">
			<div class="col-md-12">
				<div class="x_panel">
					<div class="x_title">
						<h2>
							<strong><i class="fa fa-users"></i> GRUPOS</strong>
						</h2>
					...
					<div class="x_content">
						<div class="row" align="right">
							<div class="col-md-12 col-sm-12 col-xs-12 ">
								<form method="post"
									action="<?php echo base_url() . 'Pgrupo/generarReporter' ?>">
									<div class="row">
										<div class="col-md-2 col-sm-2 col-xs-12 "></div>
										<div class="col-md-4 col-sm-4 col-xs-12 ">
											<div class="form-group">
												<select style="border-bottom: solid #ccc 2px;" name="grupo"
													style="" required="" id="idgrupo"
                                                    ...
                                                    if (isset($grupos) && ! empty($grupos)) {
                                                        foreach ($grupos as $value) {
                                                            ?>
                                                            <option
														value="<?php echo $value->idhorariodetalle ?>">
										...
										<div class="col-lg-4 col-md-4 col-sm-4 col-xs-6">
											<div class="form-group">
												...
												<select name="tiporeporte"
													style="border-bottom: solid #ccc 2px;" id="" required
													class="form-control">
								...
								<table class="table table-striped  ">
									...
									<tbody>
                                        ...
                                        if (isset($datos) && ! empty($datos)) {
											...
											<td scope="row"><strong><?php echo $value->nombrenivel . " - " . $value->nombregrupo ?></strong>
											</td>
														...
														<ul class="dropdown-menu">
															<li><a
																href="<?php echo site_url('Pgrupo/asistencia/' . $controller->encode($value->idhorario) . '/' . $controller->encode($value->idhorariodetalle)) ?>">
																	<i style="color: #31d50b;" class="fa fa-check-circle"></i>
																	Asistencia
															</a></li>
															<li>
																...
																href="<?php echo site_url('Pgrupo/tareav2/' . $controller->encode($value->idhorario) . '/' . $controller->encode($value->idhorariodetalle)) ?>"><i
																	style="color: #000;" class="fa fa-book"></i> Tarea</a>
                                                                        <?php }else{ ?>
                                                                          <a
															...
															<li><a
																href="<?php echo site_url('Pgrupo/mensaje/' . $controller->encode($value->idhorario) . '/' . $controller->encode($value->idhorariodetalle)) ?>">
																	<i style="color: #dd3115;" class="fa fa-envelope"></i>
																	Mensaje
															</a></li>
