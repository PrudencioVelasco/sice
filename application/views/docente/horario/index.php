...
<div class=""> 
 ...
 <a  target="_blank" class="btn btn-round btn-info" href="<?php echo base_url(); ?>/Phorario/imprimirHorario/<?php echo $id ?>" class="btn btn-primary"><i class="fa fa-print"></i> Imprimir Horario</a>
                           <?php }?>
