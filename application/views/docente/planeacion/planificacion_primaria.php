                        ...
                        <div class="row"> 
                            <div id="appplanificacion">
                                ...
                                <table class="table table-hover table-striped">
                                    ...
                                    <?php include 'modal_primaria.php'; ?>
                            </div>
...
<script data-my_var_1="<?php echo base_url() ?>" src="<?php echo base_url(); ?>/assets/vue/appvue/docente/planificacion/appplanificacion.js"></script> 
