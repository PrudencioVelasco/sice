...
class Materia_model extends CI_Model
{
    ...
    public function searchMateria($match, $idplantel = '')
    {
        ...
        $this->db->select("m.idmateria, m.nombreclase, e.idespecialidad, e.nombreespecialidad, n.idnivelestudio, n.nombrenivel, m.clave, m.credito, m.unidades, m.secalifica, c.idclasificacionmateria, c.nombreclasificacion, CASE niv.idniveleducativo 
        WHEN 3 THEN n.numeroromano
        WHEN 5 THEN n.numeroromano
        WHEN 1 THEN n.numeroordinaria
        WHEN 2 THEN n.numeroordinaria
